...
exports.randomInsult = exports.fuckYouToo = exports.anaylzeSpelling = void 0;
...
const randomInsult = (message, chanceOfAction, cbAction) => __awaiter(void 0, void 0, void 0, function* () {
    var d = Math.random();
    if (d < chanceOfAction) {
