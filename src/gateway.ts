...
export class Gateway {
    ...
    */
   constructor(@inject(Client) private client: Client, @inject("BOT_TOKEN") private bot_token: string) {}
    ...
    */
   public botUser() {
      if (!this.client.user) throw new Error('Unexpected no client user. Reload the bot?');
